...
mod tests {
    ...
    fn test_populate_antennas() {
        ...
        rf_inputs.push(mwalibRFInput {input: 0, 
            antenna: 101, 
            tile_id: 101, 
            tile_name: String::from("Tile101"), 
            pol: String::from("X"), 
            electrical_length_m: 101., 
            north_m: 11., east_m: 21., 
            height_m: 31., 
            vcs_order: 0, 
            subfile_order: 0, 
            flagged: false });
        
        rf_inputs.push(mwalibRFInput {input: 1, 
            antenna: 101, 
            tile_id: 101, 
            tile_name: String::from("Tile101"), 
            pol: String::from("Y"), 
            electrical_length_m: 102., 
            north_m: 12., east_m: 22., 
            height_m: 32., 
            vcs_order: 4, 
            subfile_order: 1, 
            flagged: false });

        rf_inputs.push(mwalibRFInput {input: 2, 
            antenna: 102, 
            tile_id: 102, 
            tile_name: String::from("Tile102"), 
            pol: String::from("X"), 
            electrical_length_m: 103., 
            north_m: 13., east_m: 23., 
            height_m: 33., 
            vcs_order: 0, 
            subfile_order: 0, 
            flagged: false });
        
        rf_inputs.push(mwalibRFInput {input: 3, 
            antenna: 102, 
            tile_id: 102, 
            tile_name: String::from("Tile102"), 
            pol: String::from("Y"), 
            electrical_length_m: 104., 
            north_m: 14., east_m: 24., 
            height_m: 34., 
            vcs_order: 4, 
            subfile_order: 1, 
            flagged: false });

        rf_inputs.push(mwalibRFInput {input: 4, 
            antenna: 103, 
            tile_id: 103, 
            tile_name: String::from("Tile103"), 
            pol: String::from("X"), 
            electrical_length_m: 105., 
            north_m: 15., east_m: 25., 
            height_m: 35., 
            vcs_order: 0, 
            subfile_order: 0, 
            flagged: false });
        
        rf_inputs.push(mwalibRFInput {input: 5, 
            antenna: 103, 
            tile_id: 103, 
            tile_name: String::from("Tile103"), 
            pol: String::from("Y"), 
            electrical_length_m: 106., 
            north_m: 16., east_m: 26., 
            height_m: 36., 
            vcs_order: 4, 
            subfile_order: 1, 
            flagged: false });

        rf_inputs.push(mwalibRFInput {input: 6, 
            antenna: 104, 
            tile_id: 104, 
            tile_name: String::from("Tile104"), 
            pol: String::from("X"), 
            electrical_length_m: 107., 
            north_m: 17., east_m: 27., 
            height_m: 37., 
            vcs_order: 0, 
            subfile_order: 0, 
            flagged: false });
        
        rf_inputs.push(mwalibRFInput {input: 7, 
            antenna: 104, 
            tile_id: 104, 
            tile_name: String::from("Tile104"), 
            pol: String::from("Y"), 
            electrical_length_m: 108., 
            north_m: 18., east_m: 28., 
            height_m: 38., 
            vcs_order: 4, 
            subfile_order: 1, 
            flagged: false });

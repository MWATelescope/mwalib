 ...
 * @author Greg Sleap
 * @date 18 Dec 2019
 * @brief This is the code that parses and validates command line arguments passed in from client program
 *
 */
#include <stdio.h>
#include <stdlib.h>
 ...
 *  @param[in] args Pointer to the mwalibArgs_s structure where we put the parsed arguments. 
...
/**
 * 
 *  @brief This function sets the metafits filename in the args struct and allocates a buffer for it
 *  @param[in] args Pointer to the mwalibArgs_s structure where we put the parsed arguments.
...
/**
 * 
 *  @brief This function adds a new gpubox filename in the args struct, allocates a buffer for it and increments the gpubox counter
 *  @param[in] args Pointer to the mwalibArgs_s structure where we put the parsed arguments.
 *  @param[in] filename Pointer to the filename
 *  @returns EXIT_SUCCESS on success, or -1 if there was an error.
 */
...
/**
 * 
 *  @brief This function validates command line arguments. Returns success if all good.
 *  @param[in] args Pointer to the mwalibArgs_s structure where we put the parsed arguments.
